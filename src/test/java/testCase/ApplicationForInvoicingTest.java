...
public class ApplicationForInvoicingTest {
    @Test(description = "批量造单，创建开票主表，根据主表的开票申请单号关联创建子表", invocationCount =2,threadPoolSize =1,priority = 0)
    ...
    public void test2() throws Exception{
        subInvoiceSalesApplication("kp3232424");
    }
    @Test(description = "传入申请编号在开票主表创建一条记录，同时创建子表订单", priority = 2)
    public void test3() throws Exception{
        invoiceSalesApplication("kp323242798");
    }
}
