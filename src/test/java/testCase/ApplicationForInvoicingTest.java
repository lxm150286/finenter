...
public class ApplicationForInvoicingTest {
    ...
    public void test2() throws Exception{
        subInvoiceSalesApplication("kp3229");
    }
    @Test(description = "传入申请编号在开票主表创建一条记录，同时创建子表订单", priority = 2)
    public void test3() throws Exception{
        invoiceSalesApplication("kp32324798");
    }
    @Test(description = "传入申请编号在开票主表创建一条记录，同时创建子表订单，开票申请单号为指定的单号", priority =3)
    public void test4() throws Exception{
        invoiceSalesApplication("kp324798",false);
    }
}
